        ...
        <footer class="bg-gray-900 ">
            <div class="container py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
                ...
                <div class="mt-5 lg:mt-12 flex justify-between">
                    ...
                    <div>
                        <a class="inline-flex justify-center items-center gap-x-3.5 w-8 h-8 text-center text-gray-200 hover:bg-white/[.1] rounded-md focus:outline-none focus:ring-2 focus:ring-[#FF6C22] focus:ring-offset-2 focus:ring-offset-gray-900 transition" href="#">
