            ...
            <div className='grid grid-cols-1 w-full text-center lg:text-start lg:grid-cols-2 justify-items-center items-center'>
                ...
                <div className='px-2 md:px-0'>
                    <div className='grid grid-cols-2 gap-5 my-10'>
                        <div data-aos="zoom-in" data-aos-duration="3000" className='h-60 md:h-72 lg:h-80 w-48 md:w-56 bg-[#ffffff40] hover:bg-[#ffffff20] hover:shadow-lg shadow rounded-lg'>
