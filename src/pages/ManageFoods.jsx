                    ...
                    isLoading ?
                        ...
                        (<div className='container mx-auto p-5 md:p-0'>
                            ...
                            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-10 pb-16 text-center">
                                ...
                                <h1 class="mx-auto max-w-md md:max-w-lg font-display text-4xl font-medium tracking-tight text-slate-900 lg:text-6xl">
                                ...
                                <p class="mx-auto mt-5 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">
                                    <span class="inline-block">Track, Update, and Maximize Your Impact</span>
                                </p>

                                <div class="mt-12 flex flex-col justify-center gap-y-5 sm:mt-10 sm:flex-row sm:gap-y-0 sm:gap-x-6">
                                    <Link to="https://meal-connect.vercel.app/addfood">
